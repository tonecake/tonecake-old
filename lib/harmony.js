...
var Harmony = {
    ...
    create : function(option){ // option : tone, tonality
        ...
        return getHarmony(tone, tonality);
        ...
        function getHarmony(tone, tonality){
            ...
            var harmonyset;
            if( tonality === 'dur' ){
                harmonyset = Harmony.rules.harmonie.dur;
            } else {
                harmonyset = Harmony.rules.harmonie.moll;
            }
            ...
            for( var i=0; i<harmonyset.length; i++ ){
                ...
                var harmony_result = {
                    ...
                    "tonart" : Harmony.functions.getToneByInterval(tone, harmonyset[i].interval) + '-' + harmonyset[i].tonart,
                    "akkord" : Harmony.functions.getKlang(Harmony.functions.getToneByInterval(tone, harmonyset[i].interval), harmonyset[i].tonart, harmony_septime),
                    "descendant" : [
                        {
                            "name" : "zwischen-dominant",
                            "tonart" : Harmony.functions.getToneByInterval(Harmony.functions.getToneByInterval(tone, harmonyset[i].interval), 7) + '-dur',
                            "akkord" : Harmony.functions.getKlangDominant(Harmony.functions.getToneByInterval(tone, harmonyset[i].interval), 'dur')
                        },
                        {
                            "name" : "vermindert-zwischen-dominant",
                            "tonart" : Harmony.functions.getToneByInterval(Harmony.functions.getToneByInterval(tone, harmonyset[i].interval), 11) + '-ver',
                            "akkord" : Harmony.functions.getKlang(Harmony.functions.getToneByInterval(Harmony.functions.getToneByInterval(tone, harmonyset[i].interval), 11), 'ver')
                        }
                    ]
                }
    ...
    rules : {
        ...
        harmonie : {
            ...
            "dur" : [
                {"name" : "tonika", "nameShort" : "T", "tonart" : "dur", "septime" : "dur", "interval" : 0 },
                {"name" : "sub-dominant", "nameShort" : "S", "tonart" : "dur", "interval" : 5 },
                {"name" : "sub-dominant-parallele", "nameShort" : "Sp", "tonart" : "moll", "interval" : 2},
                {"name" : "tonika-parallele", "nameShort" : "Tp", "tonart" : "moll", "interval" : 9},
                {"name" : "dominant", "nameShort" : "D", "tonart" : "dur", "interval" : 7},
                {"name" : "dominant-parallele", "nameShort" : "Dp", "tonart" : "moll", "interval" : 4},
                {"name" : "vermindert-dominant", "nameShort" : "D-", "tonart" : "ver", "interval" : 11}

            ],
            "moll" : [
                {"name" : "tonika", "nameShort" : "t", "tonart" : "moll", "septime" : "dur", "interval" : 0},
                {"name" : "sub-dominant", "nameShort" : "s", "tonart" : "moll", "interval" : 5}, //
                {"name" : "sub-dominant-parallele", "nameShort" : "sP", "tonart" : "dur", "interval" : 9}, //
                {"name" : "tonika-parallele", "nameShort" : "tP", "tonart" : "dur", "interval" : 4}, //
                {"name" : "dominant", "nameShort" : "D", "tonart" : "dur", "interval" : 7}, //
                {"name" : "dominant-parallele", "nameShort" : "dP", "tonart" : "dur", "interval" : 11}, //
                {"name" : "mollsubdominantischer-sextakkord", "nameShort" : "s⁶", "tonart" : "ver", "interval" : 2}
            ]
