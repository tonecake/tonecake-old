...
var tonecake = {
    ...
    create : function(option){
        ...
        info.created = true;
        info.currentHarmony = Harmony.create(option.tone, option.tonart);

        tonecake.pedal();

    },
    recreate : function(ton,art){
        ...
        info.created = true;
        info.currentTonart = ton + '-' + art;
        info.currentHarmony = Harmony.create(ton, art);
